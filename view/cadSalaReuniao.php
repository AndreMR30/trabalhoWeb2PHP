...
<body>
	<div class="wrapper">
		...
		<nav class="navbar navbar-expand navbar-light navbar-bg">
			...
			<main class="content">
            <?php		
			if(isset($_GET['delsRei']) and isset($_GET['cod']) ){
					$n = $_GET['nomeSala'];
					unset($_SESSION['sRei'][$_GET['cod']]);
			?>
			<div class="mb-3">
				<h1 class="h3 d-inline align-middle"><?php echo $n;?> excluído(a) do vetor!</h1>						
			</div>
			<?php					
					header("Refresh:3; conSalaReuniao.php");
			}else{
					if(isset($_GET['edisRei']) and isset($_GET['cod']) ){
						$cod = $_GET['cod'];
		    ...
		    ?>	
				...
				<div class="container-fluid p-0">
					...
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">CADASTRO DE SALA DE REUNIÃO</h1>						
					</div>
					<form action="../controller/registrar.php" method="GET">
                    <input type="hidden" name="editarsRei" value="<?php echo $cod;?>">
					<div class="form-row">
					<div class="form-group col-md-6">
                <div class="form-group col-md-6">
                     <label for="inputNomeSala">Nome da Sala</label>
                <input type="text" class="form-control" name="nomeSala" value="<?php echo $nomeSala; ?>" placeholder="Digite o nome da sala">
                </div>
