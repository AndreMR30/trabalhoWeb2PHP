...
<body>
	<div class="wrapper">
		...
		<nav class="navbar navbar-expand navbar-light navbar-bg">
			...
			<main class="content">
            <?php		
			if(isset($_GET['delAudi']) and isset($_GET['cod']) ){
					$n = $_GET['nomeAuditorio'];
					unset($_SESSION['Audi'][$_GET['cod']]);
			?>
			<div class="mb-3">
				<h1 class="h3 d-inline align-middle"><?php echo $n;?> excluído(a) do vetor!</h1>						
			</div>
			<?php					
					header("Refresh:3; conAuditorio.php");
			}else{
					if(isset($_GET['ediAudi']) and isset($_GET['cod']) ){
						$cod = $_GET['cod'];
						$nomeAuditorio = $_GET['nomeAuditorio'];
						$proprietario =$_GET['proprietario'];
						$email =$_GET['email'];
						$qtdPessoa =$_GET['qtdPessoa'];
		    ...
		    ?>	
				...
				<div class="container-fluid p-0">
					...
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">CADASTRO DE AUDITÓRIO</h1>						
					</div>
					<form action="../controller/registrar.php" method="GET">
                    <input type="hidden" name="editarAudi" value="<?php echo $cod;?>">
					<div class="form-row">
					<div class="form-group col-md-6">
                <div class="form-group col-md-6">
                     <label for="inputNomeAuditorio">Nome do Auditório</label>
                <input type="text" class="form-control" name="nomeAuditorio" value="<?php echo $nomeAuditorio; ?>" placeholder="Digite o nome do Auditório">
                </div>
        ...
        <div class="form-group col-md-6">
            <label for="qtdPessoa">Numero Máximo de Pessoas/Usuarios</label>
            <input type="number" class="form-control" name="qtdPessoa" value="<?php echo $qtdPessoa; ?>" placeholder="" required>
        </div>
    </div>
